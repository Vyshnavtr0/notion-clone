...
export const Navigation = () => {
    ...
    const handleCreate = () => {
        const prosime = create({ titile: "Untitled" })
        toast.promise(prosime, {
    ...
    return (
        ...
        <>
            <aside
                ref={sidebarRef}
                className={cn("group/sidebar h-full bg-secondary overflow-y-auto relative w-60 flex flex-col z-99999]", isResetting && "transition-all duration-300 ease-in-out", isMobile && "w-0")}>
